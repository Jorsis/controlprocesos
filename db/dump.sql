...
SELECT pg_catalog.setval(pg_catalog.pg_get_serial_sequence('unidades', 'unidad'), 1133, true);
...
COPY cliente (id_usuario, nombre_usuario, tipo, "password", activo, id_cliente, nombre_cliente, direccion, telefono) FROM stdin;
\.
...
COPY orden (orden, referencia, unidades, ingreso, especie, tipo, corte, peso, ancho, largo, espesor, calidad, novedad) FROM stdin;
2345		5	1215280686									
\.
...
COPY proceso (id_proceso, nombre, descripcion, obligatorio, orden_proceso) FROM stdin;
CR001	CRUDA		f	\N
RF001	REFRIGERACION		f	\N
CUR001	CURTIDO		f	\N
REM001	REMOJO		f	\N
BLA001	BLANQUEO		f	\N
TEÑ001	TEÑIDO		f	\N
ACA001	ACABADO		f	\N
MOV001	MOVILIZACION		f	\N
\.
...
COPY seguimiento (orden, proceso, unidad, inicio, finalizacion) FROM stdin;
2345	CR001	1129	1215280764	1215280815
2345	CR001	1130	1215280769	1215280829
2345	CR001	1131	1215280779	1215280834
2345	CR001	1132	1215280784	1215280839
2345	CR001	1133	1215280789	1215280845
\.
...
COPY unidades (unidad, orden) FROM stdin;
1129	2345
1130	2345
1131	2345
1132	2345
...
COPY usuario (id_usuario, nombre_usuario, tipo, "password", activo) FROM stdin;
\.
...
COPY usuario_control (id_usuario, nombre_usuario, tipo, "password", activo, cedula, nombre) FROM stdin;
71319726	darcila	usuario	6c26fc9d4bf493a4b65d531ed1896471	f	71319726	DIEGO ARCILA HERRERA
1234567	USUARIO	usuario	f8032d5cae3de20fcec887f395ec9a6a	f	1234567	USUARIO
70033031	cdiazz	admin	0dfd44e44b4e4bb70b6ff1afb4c3acb6	t	70033031	CARLOS ARTURO
\.
