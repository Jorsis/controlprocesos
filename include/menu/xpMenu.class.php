...
class xpMenu{
	...
	*/
	...
	function xpMenu(){
		...
		$this->submenu_onmouseout		= '#999999'; //F5F5F5
		// backgroundcolor of menu
		$this->menu_backgroundcolor		= 'buttonface';
		// backgroundcolor of options
		$this->option_backgroundcolor		= '#999999'; //F5F5F5
		// menu width
		$this->menu_width			= '250px';
		// option width
		$this->option_width			= '300px';
		// menu height
		$this->menu_height			= '40px';
		// option height
		$this->option_height			= '35px';
	...
	*/
	...
	function style(){
		...
		<style type="text/css">
		body,td {
		color: #000000;font-family:tahoma, verdana, helvetica; font-size: 14px; font-weight:none;
		}
