		...
		foreach ($this->PARAMS as $key => $value)
		{
			...
			switch($validationFlag)
			{
				...
				case "1" : // Validation for "Not Blank"
						if($this->isBlank($value,"")) $this->error_msg .="<li>".$fieldName." no puede estar en blanco</li>";
						break;
				...
				case "3" : // Validation for "Option email"
						if(!$this->isEmail($value,"")) $this->error_msg .="<li>Invalido ".$fieldName."</li>";
						break;
 ...
 */
	...
	function isDate($value, $option) {
		...
		//print_r($date_array);
		$val=checkdate($date_array[1],$date_array[2],$date_array[0]);
